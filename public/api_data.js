define({ "api": [
  ...
  },
  {
    ...
    "group": "Appointments",
    "version": "1.0.0",
    "description": "<p>This endpoint allow an authorized patient to delete an appointment. In this case the appointment becomes an available timeslot in the doctor's calendar.</p> <p>This resource is protected. Therefore, you must include <code>Authorization: Bearer token</code> header.</p>",
    "header": {
      "fields": {
        "Authorization Header": [
          {
        ...
        "Success 2xx": [
          {
            ...
            "optional": false,
            "field": "200",
            "description": "<p>OK Appointment was successfully deleted</p>"
          }
        ]
      }
    },
      ...
      "fields": {
        "Error 4xx": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "404",
            "description": "<p>Appointment was not found</p>"
          }
        ],
        "Error 5xx": [
          {
      ...
      "fields": {
        "Error 4xx": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "404",
            "description": "<p>No appointments were found</p>"
          }
        ],
        "Error 5xx": [
          {
        ...
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "id",
            "description": "<p>Appointment's unique id.</p>"
          }
        ]
      }
    },
  ...
  },
  {
    ...
    "group": "Appointments",
    "version": "1.0.0",
    "description": "<p>An autorized patient can update the description of their own appointments to include symptoms or send a message to the doctor or clinic. This resource is protected. Therefore, you must include <code>Authorization: Bearer token</code> header.</p>",
    "header": {
      "fields": {
        "Authorization Header": [
          {
        ...
        "Success 2xx": [
          {
            ...
            "optional": false,
            "field": "200",
            "description": "<p>OK Appointment was successfully updated</p>"
          }
        ]
      }
    },
        ...
        "Parameter": [
          {
            ...
            "optional": true,
            "field": "query",
            "description": "<p>Either part of doctor's name, speciality, clinic or part of address. The API supports multi word searches. This means we can pass multiple query parameters like so: <code>/query=value1&amp;query=value2</code>. In this case the API returns doctors matching at least one of the query values, the logical operation between them being <code>OR</code>.</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
